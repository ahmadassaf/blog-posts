...
One element that i use that is not part of Übersicht is [Dateline](https://dateline.macupdate.com/). It is a discrete desktop calendar with support to iCal and other calendar applications.
...
To further customize the dock, i use [Dockmod](https://macappstore.org/dockmod/) which is the most feature-rich application for dock theming with support up to OSX Yosemite in order to provide a transparent Dock background. Dockmod can be also installed via my `caskfile`.
...
Although i have the latest OSX Yosemite update, i am still unhappy with the capabilities of the Finder. I have found that [PathFinder](https://cocoatech.io/) is a great replacement. Just head over and you can check the list of things you can do with this great piece of software.
