...
First, lets start with the light weight things. The desktop and general UI enhancement. I always loved to show some nice widgets on my desktop, and for that I used [Übersicht](http://tracesof.net/uebersicht/). Before it I had used [Geektool](http://projects.tynsoe.org/en/geektool/), which basically allows you to run custom scripts and display them on the desktop, but I wasn't at all happy with the experience of styling those "widgets" and the availability of 3rd party widgets.
