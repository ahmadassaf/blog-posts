...
<Callout type='warning'>This post is old and for an up-to-date instructions in setting up your machine and dealing with dotfiles, head over to my article about my bash framwork [**gaudi**](https://github.com/g-udi)</Callout>
