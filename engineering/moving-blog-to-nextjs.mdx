...
Facing issues? Check the [FAQ page](https://github.com/timlrx/tailwind-nextjs-starter-blog/wiki) and the <Preview url='https://github.com/timlrx/tailwind-nextjs-starter-blog'/> and do a search on past issues. Feel free to open a new issue if none has been posted previously.

<Preview preview={false} url="https://www.youtube.com/watch?v=aircAruvnKk&list=PLZHQObOWTQDNU6R1_67000Dx_ZCJB-3pi&index=2&ab_channel=3Blue1Brown"/> Feature request? Check the past discussions to see if it has been brought up previously. Otherwise, feel free to start a new discussion thread. All ideas are welcomed!
