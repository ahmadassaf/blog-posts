...
One of the reasons I moved to a Jekyll, markdown-based blog is to enable people to contribute to my posts. To do so, I host the posts in a separate GitHub repository (since made private) and include it as a git submodule by configuring the `.gitmodules` as follows:
