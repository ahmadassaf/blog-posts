...
Since one of the reasons I moved to Jekyll and markdown-based blog is to enable people to contribute to my posts. To do so, I host the posts into a [separate Github repository](https://github.com/ahmadassaf/blog-posts) and include that as a separate git submodule by configuring the `.gitmodules` as follows:
