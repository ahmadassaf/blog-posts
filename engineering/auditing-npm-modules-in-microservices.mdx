...
- Supports ES6-style [`import from`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Statements/import) syntax.
...
- Works with any public npm registry, [private registries](https://docs.npmjs.com/cli/using-npm/registry), and alternate registries like [Sinopia](https://github.com/rlidwka/sinopia).
