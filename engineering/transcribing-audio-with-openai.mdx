...
The <Preview url="https://github.com/jiaaro/pydub"/> library is used for audio processing, and openai is the official library to interact with OpenAI’s APIs.
...
For more information on the Whisper API and its capabilities, check the <Preview title="OpenAI API documentation" url="https://platform.openai.com/docs/api-reference/audio"/>