...
RDF is the standard to model information in the Semantic Web. Linked Data publishers can pick from a [plethora of tools](http://www.w3.org/2001/sw/wiki/SWValidators) that can automatically check their RDF files for quality problems. Syntactic RDF checkers are able to detect errors in RDF documents like the [W3C RDF Validator](http://www.w3.org/RDF/Validator), [RDF:about validator and Converter](http://rdfabout.com/demo/validator) and [The Validating RDF Parser (VRP)](http://139.91.183.30:9090/RDF/VRP/index.html). [The RDF Triple-Checker](http://graphite.ecs.soton.ac.uk/checker) is an online tool that helps find typos and common errors in RDF data. [Vapour](https://www.w3.org/2001/sw/wiki/SemanticWebTools#On-line_Validators) [@Berrueta:SFSW:08] is a validation service to check whether semantic Web data is correctly published according to the current best practices [@Berners-Lee:W3C:06].
