...
<Image className='dark:hidden mx-auto' width={800} height={800} src="/static/images/posts/jekyll-ci.svg"/>
<Image className='hidden dark:block mx-auto' width={800} height={800} src="/static/images/posts/jekyll-ci-dark.svg"/>
