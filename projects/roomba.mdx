...
Although Roomba is generic and accepts any data model to check against, for the moment we have used the the [CKAN standard model](https://docs.ckan.org/en/latest/api/).
