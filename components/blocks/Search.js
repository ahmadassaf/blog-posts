const Search = ({ setSearchValue }) => (
  <div className='relative mt-8 border-none'>
    <input
      ...
      className='block outline-none w-full border-none bg-white px-0 py-2 text-gray-900 focus:border-none dark:border-gray-900 dark:bg-gray-800 dark:text-gray-100'
    />
