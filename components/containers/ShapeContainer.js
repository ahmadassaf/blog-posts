export default function ShapeContainer({ startingColor, endingColor }) {
  return (
    <div className='absolute -top-80 left-[max(6rem,33%)] -z-10 transform-gpu blur-3xl sm:left-1/2 md:top-20 lg:ml-20 xl:top-3 xl:ml-56' aria-hidden='true'>
      ...
      />
      <div
        className='absolute inset-y-0 right-1/2 -z-10 -mr-96 w-[200%] origin-top-right skew-x-[-30deg] dark:bg-gray-800 bg-white shadow-xl shadow-indigo-600/10 ring-1 ring-blue-50 sm:-mr-80 lg:-mr-96'
        aria-hidden='true'
      />
    </div>
  );
