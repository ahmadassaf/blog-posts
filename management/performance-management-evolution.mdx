...
These teams are hidden by traditional HR and performance management systems that build around an org-chart. Today's tools/technologies need to be able to allow teams to be created easily.
...
If you adopt this, start with a pilot team, prove the time savings, and expand from there. That turned out to be the easy part. The harder discovery came after the rollout.
