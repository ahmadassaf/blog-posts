...
## Progression via impact: the framework we use at Mav9

Everything above stays philosophy until it survives contact with compensation and promotion. So here is the framework we actually run at Mav9, published as-is, because this is the part people always ask about.
