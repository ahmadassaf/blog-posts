...
3. When the company is very small, titles shouldn't matter; when it grows large, M2 through M6 typically expand with senior titles.
4. As the company grows, you will periodically need to re-level people (Dunbar's number is a useful baseline for when).
5. ICs and leads sit on the same scale, because impact is the measure. M6 ICs are rare but not unheard of.
